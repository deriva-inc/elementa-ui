...
function SelectLabel({
    ...
    return (
        <SelectPrimitive.Label
            ...
            className={cn(
                'text-text-primary font-body px-1.5 py-1 text-xs',
                className
            )}
            {...props}
        />
...
function SelectSeparator({
    ...
    return (
        <SelectPrimitive.Separator
            ...
            className={cn(
                'bg-stroke-flat-primary pointer-events-none -mx-1 my-1 h-px',
                className
            )}
            {...props}
        />
...
function SelectScrollUpButton({
    ...
    return (
        <SelectPrimitive.ScrollUpButton
            ...
            className={cn(
                "bg-bg-flat-primary z-10 flex cursor-default items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4",
                className
            )}
            {...props}
        >
