...
function DrawerOverlay({
    ...
    return (
        <DrawerPrimitive.Overlay
            ...
            className={cn(
                'data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 bg-bg-flat-primary/10 fixed inset-0 z-50 supports-backdrop-filter:backdrop-blur-xs',
                className
            )}
            {...props}
        />
    ...
    return (
        <DrawerPortal data-slot="drawer-portal">
            ...
            <DrawerPrimitive.Content
                ...
                className={cn(
                    'group/drawer-content bg-bg-modal-primary text-text-primary fixed z-50 flex h-auto flex-col text-sm',
                ...
                {...props}
            >
                <div className="bg-bg-muted mx-auto mt-4 hidden h-1 w-25 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
                {children}
            </DrawerPrimitive.Content>
        </DrawerPortal>
    );
