...
function DialogOverlay({
    ...
    return (
        <DialogPrimitive.Overlay
            ...
            className={cn(
                'data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 isolate z-50 duration-100 supports-backdrop-filter:backdrop-blur-xs',
                className
            )}
            {...props}
        />
...
function DialogFooter({
    ...
    return (
        <div
            ...
            className={cn(
                'bg-bg-modal-secondary/50 -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 sm:flex-row sm:justify-end',
                className
            )}
            {...props}
        >
...
function DialogDescription({
    ...
    return (
        <DialogPrimitive.Description
            ...
            className={cn(
                'text-text-secondary *:[a]:hover:text-text-primary text-sm *:[a]:underline *:[a]:underline-offset-3',
                className
            )}
            {...props}
        />
