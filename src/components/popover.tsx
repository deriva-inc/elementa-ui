...
function PopoverTitle({ className, ...props }: React.ComponentProps<'h2'>) {
    return (
        <div
            ...
            className={cn(
                'font-heading text-text-secondary text-primary font-medium',
                className
            )}
            {...props}
        />
